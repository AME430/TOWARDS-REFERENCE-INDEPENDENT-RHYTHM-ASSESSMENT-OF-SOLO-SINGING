...
configure('runs/chro_ph_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1', flush_secs=2)  # modify

# Parameteres for Spectral Representation
rep_params = {'method': 'Chromagram', 'n_chroma': 96, 'hop_length': 512, 'cqt_mode': 'hybrid', 'normalize': True}
...
for epoch in range(num_epochs):
    ...
    if val_pearson > best_val_corr:
        ...
        torch.save(model, './models_hybrid/model_SpectralCRNN_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1_chro_ph')

...
configure('/home/chitra/workspace/code/JinhuLi/log/exp_onlyrh', flush_secs=2)  # modify

# Parameteres for Spectral Representation
rep_params = {'method': 'CQT', 'hop_length': 512, 'n_bins': 96, 'bins_per_octave': 24, 'normalize': True}

# Load Datasets
train_dataset = SpectralDataset('/home/chitra/workspace/code/JinhuLi/dill_onlyrh/train_1.dill', 0, rep_params)
train_dataloader = SpectralDataLoader(train_dataset, batch_size=5, num_workers=4, shuffle=True)
# pdb.set_trace()

test_dataset = SpectralDataset('/home/chitra/workspace/code/JinhuLi/dill_onlyrh/test_1.dill', 0, rep_params)
test_dataloader = SpectralDataLoader(test_dataset, batch_size=5, num_workers=1, shuffle=True)

valid_dataset = SpectralDataset('/home/chitra/workspace/code/JinhuLi/dill_onlyrh/val_1.dill', 0, rep_params)
...
for epoch in range(num_epochs):
    ...
    if val_pearson > best_val_corr:
        ...
        torch.save(model, '/home/chitra/workspace/code/JinhuLi/model/exp_onlyrh')
